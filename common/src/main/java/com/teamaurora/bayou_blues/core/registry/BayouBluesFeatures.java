...
public class BayouBluesFeatures {
    ...
    public static final class Configured {
        ...
        public static final TreeConfiguration GROWN_CYPRESS_CONFIG = (new TreeConfiguration.TreeConfigurationBuilder(
        ...
        public static final Supplier<ConfiguredFeature<TreeConfiguration, ?>> GROWN_CYPRESS_TREE = CONFIGURED_FEATURES.register("cypress_grown", () -> new ConfiguredFeature<>(CYPRESS_TREE.get(), GROWN_CYPRESS_CONFIG));
        public static final Supplier<ConfiguredFeature<TreeConfiguration, ?>> GROWN_MEGA_CYPRESS_TREE = CONFIGURED_FEATURES.register("mega_cypress_grown", () -> new ConfiguredFeature<>(MEGA_CYPRESS_TREE.get(), GROWN_CYPRESS_CONFIG));
    }
}