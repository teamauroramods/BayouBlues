...
public class BayouBluesFeatures {
    ...
    public static final class Configured {
        ...
        public static final Supplier<ConfiguredFeature<TreeConfiguration, ?>> GROWN_MEGA_CYPRESS_TREE = CONFIGURED_FEATURES.register("mega_cypress_grown", () -> new ConfiguredFeature<>(CYPRESS_TREE.get(), GROWN_CYPRESS_CONFIG));
        public static void load(Platform platform) {
            LOGGER.debug("Registered to platform");
